<div style="display: flex;">
          ...
          <label style="font-size: 30px; text-align: center;">Contenido de la nota</label>
            <div class="btn-toolbar editor"  data-role="editor-toolbar" data-target="#editor-one" style="box-shadow: 2px 2px 2px rgba(0,0,0,.5); border: 1px solid rgba(0,0,0,.4);">
                  ...
                  <div id="editor-one" class="editor-wrapper contenido descripcion_nota" style="height: 200px; width: 100%;"></div>
                  <br><br>
                  <input type="submit" style="font-size: 20px;" value="Publicar nota" id="Publicar_nota" class="btn btn-success btn-block">

</div><br><br>
<div style="width: 25%; margin: 30px;">
  
    <div>
      <label style="font-size: 20px;" >Selecciona el tipo el color</label><br>
